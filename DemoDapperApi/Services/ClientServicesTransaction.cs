    ...
    public partial class ClientServices
    {
        ...
        public void AddClientWithSavePointManyContext(Cliente cliente)
        {
            ...
            try
            {
                ...
                DemoTrigger.Employees.Add(new Employee { FirstName = "Osman", LastName = "Cruz" });
                DemoTrigger.CallOutcomes.Add(new CallOutcome { OutcomeText = "Llamada de prueba - OS dev" });
                DemoTrigger.CallOutcomes.Add(new CallOutcome { OutcomeText = "Llamada de prueba 2 Llamada de prueba 2" });
